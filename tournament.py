...
def main():
    ...
    test_agents = [
        ...
        Agent(AlphaBetaPlayer(score_fn=custom_score), "LookAhead"),
        Agent(AlphaBetaPlayer(score_fn=custom_score_2), "RunBoyRun"),
        Agent(AlphaBetaPlayer(score_fn=custom_score_3), "DangerousChase")
    ]
